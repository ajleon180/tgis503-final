var config = {
    ...
    chapters: [
      ...
      },
      {
        ...
        description: '<p>Dotonbori Street (Sotenbori Street in <i>Yakuza 2</i>) is the main commercial street in Dotonburi. In <i>Yakuza 2</i>, Sotenbori Street contains restaurants and entertainment venues that Kiryu can visit when he is taking a break from the main events of the story. One end of Sotenbori Street is dominated by the Cabaret Grand, where Kiryu first meets Ryuji Goda.</p><p><img src="images/Dotonbori_Street_y2.png" alt="Dotonbori River in Yakuza 2"></p><p>Photo Credits - Top Photo: Oilstreet; Bottom Photo: Copyright, SEGA</p>',
        location: {
      ...
      },
      {
        ...
        description: 'Much of the action in <i>Yakuza 2</i> takes place in Kamurocho (Kabukicho), Tokyo, where Kiryu must avert a brewing war between the Tojo Clan and the Go-Ryu Clan of the Omi Alliance while searching for foreign operatives working to upset the balance of power. The neighborhood is largely the same as in <i>Yakuza 1</i>, aside from a few newly navigable alleys and a large construction project in West Park.',
        location: {
          center: [139.69995, 35.69621],
          zoom: 16,
          pitch: 50,
